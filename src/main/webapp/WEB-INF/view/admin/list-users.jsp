...
<body>
    <div class="container">
        ...
        <div class="pagination">
            <% if (currentPage > 1) { %>
                <a href="${pageContext.request.contextPath}/admin/list-users?page=<%=currentPage - 1%>" class="pagination-link">&laquo; Prev</a>
            <% } %>
            ...
            <%
                ...
                if (currentPage > 3) {
            %>
                <a href="${pageContext.request.contextPath}/admin/list-users?page=1" class="pagination-link">1</a>
                <% if (currentPage > 4) { %>
            ...
            %>
                <a href="${pageContext.request.contextPath}/admin/list-users?page=<%=i%>" class="pagination-link <%=i == currentPage ? "active" : ""%>"><%=i%></a>
            <% } %>
            ...
            %>
                    <span class="pagination-separator">...</span>
            <%      } %>
                <a href="${pageContext.request.contextPath}/admin/list-users?page=<%=totalPages%>" class="pagination-link"><%=totalPages%></a>
            <% } %>

            <% if (currentPage < totalPages) { %>
                <a href="${pageContext.request.contextPath}/admin/list-users?page=<%=currentPage + 1%>" class="pagination-link">Next &raquo;</a>
            <% } %>

            <span class="pagination-info">Showing <%=(currentPage - 1) * 10 + 1%>-<%=Math.min(currentPage * 10, totalUsers)%> of <%=totalUsers%> users</span>
        </div>
        <% } %>
    </div>
